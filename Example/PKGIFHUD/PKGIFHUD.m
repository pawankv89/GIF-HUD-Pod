...
#pragma mark - PKGIFHUD Implementation

@implementation PKGIFHUD


#pragma mark Lifecycle

static PKGIFHUD *instance;

+ (instancetype)instance {
    if (!instance) {
        instance = [[PKGIFHUD alloc] init];
    }
    return instance;
}

- (instancetype)init {
    if ((self = [super initWithFrame:CGRectMake(0, 0, Size_width, Size_height)])) {
